...
public class Admin {
	...
	public static int getNumberOfProducts() throws FileNotFoundException {
		productReader =  new Scanner(new File("\\productDetails.csv"));
		int noOfProducts=0;
		try (BufferedReader reader = new BufferedReader(new FileReader("\\productDetails.csv"))) {
	...
	public void addProduct(int prodID, String prodName, double rate) throws IOException {
		Product p = new Product(prodID, prodName, rate);
		FileWriter fw = new FileWriter(new File("\\productDetails.csv"));
		String s = "";
	...
	public void removeProduct(int prodID) throws IOException {
		File csvFile = new File("productDetails.csv");
...
//	}
	...
	public void viewCustomer() throws IOException {
		...
		FileReader fileR = new FileReader("\\CustomerInfo.csv");
		System.out.println("\n********************************************\n");
...
//		Scanner sc = new Scanner(new File("CustomerInfo.csv"));
//		sc.useDelimiter(",");
//		
//		while(sc.hasNext()) {
